    ...
    Scaffold(
        ...
        Column(
            ...
            LazyVerticalGrid(
                ...
                contentPadding = PaddingValues(dimensionResource(R.dimen.size_xxl)),
                horizontalArrangement = Arrangement.spacedBy(dimensionResource(R.dimen.size_xxl)),
                verticalArrangement = Arrangement.spacedBy(dimensionResource(R.dimen.size_xxl))
            ) {
